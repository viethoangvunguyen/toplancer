                            ...
                            <div class="row">
                                <div class="col-xl-12">
                                    ...
                                    <div class="submit-field">
                                        ...
                                        <p><?php _e("Start with a bit about yourself or your business, and include an overview of what you need done.") ?>
                                        </p>
                                    ...
                                    <div class="submit-field">
                                        ...
                                        <p><?php _e("Enter up to 5 skills that best describe your project. Freelancers will use these skills to find projects they are most interested and experienced in.") ?>
                                        </p>
                                        <select name="subcatid[]" class="selectpicker" data-live-search="true"
                                            data-size="7" data-max-options="5" multiple>
                                    ...
                                    <div class="submit-field">
                                        ...
                                        <span class="radio-btn">
                                            <input id="fixed_price" class="projecttypRadio" type="radio"
                                                name="salary_type" value="0" onFocus="return show1();"
                                                checked="checked" />
                                            <label for="fixed_price"><?php _e("Fixed Price") ?></label>
                                        </span>
                                        <span class="radio-btn">
                                            <input id="hourly_price" class="projecttypRadio" type="radio"
                                                name="salary_type" value="1" onFocus="return show1();" />
                                            <label for="hourly_price"><?php _e("Hourly Price") ?></label>
                                        </span>
                                    </div>
                                    <div class="submit-field">
                                        <h5><?php _e("What is your estimated budget?") ?>
                                            (<?php _esc($config['currency_code'])?>)</h5>
                                        ...
                                        <div class="row">
                                            ...
                                            <div id="show1" style="display:none; margin-top: 6px;"><span
                                                    class="fbold">/<?php _e("hrs") ?></span></div>
                                        </div>
                                    </div>
                            ...
                            <div class="payment">
                                ...
                                <div class="payment-tab payment-tab-active">
                                    ...
                                    <div class="payment-tab-content">
                                        <p><?php _e("Free to post, your project will go live instantly and start receiving bids within seconds.") ?>
                                        </p>
                                    </div>
                                </div>
