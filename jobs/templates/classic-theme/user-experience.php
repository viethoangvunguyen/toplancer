                                ...
                                <div class="row">
                                    <div class="col-xl-6 col-md-12">
                                        <div class="submit-field">
                                            ...
                                            <input type="text" class="with-border margin-bottom-0" data-provide="datepicker" data-date-format="dd-mm-yyyy" data-date-autoclose="true" data-date-language="<?php _esc($config['lang_code']) ?>" data-date-end-date="0d" name="start_date" value="<?php _esc($start_date)?>" <?php if($language_direction == 'rtl') echo 'data-date-rtl="true"'; ?> required>
                                        </div>
                                    </div>
                                    <div class="col-xl-6 col-md-12">
                                        <div class="submit-field">
                                            <h5><?php _e("End Date") ?></h5>
                                            <input type="text" class="with-border margin-bottom-0" data-provide="datepicker" data-date-format="dd-mm-yyyy" data-date-autoclose="true" data-date-language="<?php _esc($config['lang_code']) ?>" data-date-end-date="0d" name="end_date" value="<?php _esc($end_date)?>" <?php if($language_direction == 'rtl') echo 'data-date-rtl="true"'; ?>>
                                        </div>
                                    </div>
                                </div>
                                <div class="submit-field">
