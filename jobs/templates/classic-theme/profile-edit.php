                                    ...
                                    <?php if($usertype == "user") { ?>
                                        ...
                                        <div class="col-xl-4 col-md-12">
                                            <div class="submit-field">
                                                ...
                                                <input type="text" class="with-border margin-bottom-0" data-provide="datepicker" data-date-format="dd-mm-yyyy" data-date-autoclose="true" data-date-language="<?php _esc($config['lang_code']) ?>" name="dob" value="<?php _esc($dob)?>" <?php if($lang_direction == "rtl"){ echo 'data-date-rtl="true"'; }?> >
                                            </div>
                                        </div>
                                    <?php } ?>
                                    <div class="col-xl-6 col-md-12">
