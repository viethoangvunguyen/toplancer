    ...
    <div class="dashboard-content-container" data-simplebar>
        <div class="dashboard-content-inner">
            ...
            <div class="dashboard-headline">
                ...
                <span class="margin-top-7"><?php _e("for") ?> <a
                        href="<?php url("PROJECT") ?>/<?php _esc($project_id)?>"><?php _esc($project_name)?></a></span>
                <!-- Breadcrumbs -->
                ...
                <div class="col-xl-12">
                    <div class="dashboard-box">
                        ...
                        <div class="headline">
                            ...
                            <a href="#small-dialog-1" class="popup-with-zoom-anim button ripple-effect"><i
                                    class="icon-feather-plus"></i> <?php _e("Create Milestone") ?></a>
                            <?php } ?>
                        </div>
                        <div class="content">
                                ...
                                <div class="margin-bottom-20">
                                    <div class="fun-facts-container">
                                        ...
                                        <div class="fun-fact" data-fun-fact-color="#b81b7f">
                                            ...
                                            <div class="fun-fact-icon"><i
                                                    class="icon-material-outline-business-center"></i></div>
                                        </div>
                                        <div class="fun-fact" data-fun-fact-color="#efa80f">
                                            <div class="fun-fact-text">
                                                <span><?php _e("Paid") ?></span>
                                                <h4><?php _esc($epaid)?></h4>
                                            </div>
                                            <div class="fun-fact-icon"><i class="icon-material-outline-rate-review"></i>
                                            </div>
                                        </div>
                                    ...
                                    <table class="basic-table dashboard-box-list d-none">
                                        <tr>
                                            <td><?php _e("Total Milestone Amount") ?> : </td>
                                            <td><?php _esc($config['currency_sign'])?><?php _esc($total_ea)?></td>
                                        </tr>
                                        <tr>
                                            <td><?php _e("Pending Milestone") ?> : </td>
                                            <td><?php _esc($config['currency_sign'])?><?php _esc($epanding)?></td>
                                        </tr>
                                        <tr>
                                            <td><?php _e("Remaining Amount") ?> : </td>
                                            <td><?php _esc($config['currency_sign'])?><?php _esc($remainning_amount)?>
                                            </td>
                                        </tr>
                                    </table>
                                </div>
                                <table class="basic-table dashboard-box-list" id="js-table-list">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="ajax-item-listing" data-item-id="<?php _esc($milestone['id'])?>">
                                            <td data-label="<?php _e("Description") ?>">
                                                <?php _esc($milestone['title'])?>
                                                <br><small><?php _esc($milestone['start_date'])?></small>
                                            </td>
                                            <td data-label="<?php _e("Amount") ?>">
                                                <?php _esc($milestone['amount'])?><?php _esc($config['currency_sign'])?>
                                            </td>
                    ...
                    <div class="popup-tabs-container">
                        ...
                        <div class="popup-tab-content" id="tab">
                            <form id="create-milestone-form" method="post" action="#">
                                ...
                                <input name="title" value="" type="text" placeholder="Miêu tả" />

                                <input name="amount" value="" type="text"
                                    placeholder="<?php _e("Amount") ?> <?php _esc($config['currency_code'])?>" />
                                <?php
                    if($usertype == "employer"){
                        echo '<p class="help-message">'.__("Phí hoa hồng").' '._esc($employer_commission,false).'%</p>';
                    }else{
                        echo '<p class="help-message">'.__("Phí hoa hồng").' '._esc($freelancer_commission,false).'%</p>';
                    }
                    ?>
                                ...
                                <div class="radio">
                                    ...
                                    <label for="radio-1"><span class="radio-label"></span>
                                        <?php _e("I have read and agree to the Terms and Conditions") ?></label>
                                </div>
                                <!-- Button -->
                                <button id="create-milestone-button"
                                    class="margin-top-15 button full-width button-sliding-icon ripple-effect"
                                    type="submit"> <?php _e("Submit") ?> <i
