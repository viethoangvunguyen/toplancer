                    ...
                    <li>
                        ...
                        <div class=" tg-verticalscrollbar tg-dashboardscrollbar">
                            <ul id="sub_category">
                                ...
                                <li data-ajax-subcatid="<?php _esc($subcat['id'])?>"
                                    class="<?php _esc($subcat['selected'])?>"><a
            ...
            <div class="col-xl-8 col-md-12">
                ...
                <form id="post_job_form" action="<?php url("EDIT-JOB") ?>?action=edit_ad" method="post"
                                ...
                                <div class="col-xl-12">
                                    ...
                                    <div class="form-group selected-product" id="change-category-btn"
                                        ...
                                        <ul class="select-category list-inline">
                                            ...
                                            <li id="sub-category-text" <?php if($subcategory == ""){ ?>
                                        ...
                                        <input type="hidden" id="input-maincatid" name="catid"
                                            value="<?php _esc($catid)?>">
                                        <input type="hidden" id="input-subcatid" name="subcatid"
                                            value="<?php _esc($subcatid)?>">
                                    </div>
                                    <div class="submit-field">
                                        <h5><?php _e("Title") ?> *</h5>
                                        ...
                                        <div class="input-with-icon">
                                            <div id="autocomplete-container"
                                                ...
                                                <input class="with-border" type="text"
                                                    ...
                                                    id="address-autocomplete" value="<?php _esc($location)?>">
                                            </div>
                                    ...
                                    <div class="submit-field form-group">
                                        ...
                                        <div class="input-with-icon">
                                            <input class="with-border" type="text" placeholder=""
                                                name="url_map" value="<?php echo htmlentities($url_map);?>">
                                    ...
                                    <div class="payment-tab-content">
                                        ...
                                        <div class="row premium-plans">
                                            ...
                                            <div class="col-lg-3 premium-plans-price">
                                                <?php _esc($user_currency_sign)?><?php _esc($featured_fee)?>
                                        ...
                                        <div class="row premium-plans">
                                            ...
                                            <div class="col-lg-3 premium-plans-price">
                                                <?php _esc($user_currency_sign)?><?php _esc($urgent_fee)?>
                                        ...
                                        <div class="row premium-plans">
                                            ...
                                            <div class="col-lg-3 premium-plans-price">
                                                <?php _esc($user_currency_sign)?><?php _esc($highlight_fee)?>
                    ...
                    <div class="dashboard-box">
                        ...
                        <div class="content with-padding padding-bottom-10">
                            <div class="submit-field">
                                <h5><?php _e("Message to the Reviewer") ?> *</h5>
                    ...
                    <div class="row margin-top-30 margin-bottom-80" style="align-items: center;">
                        <div class="col-6">
                            <button type="submit" id="submit_job_button" name="Submit"
                                class="button ripple-effect big"><i class="icon-feather-plus"></i>
                                <?php _e("Post a Job") ?></button>
                        </div>
                        <div class="col-6">
