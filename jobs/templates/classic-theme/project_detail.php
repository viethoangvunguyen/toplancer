                    ...
                    <div class="left-side">
                        ...
                        <div class="header-details">
                            ...
                            <ul>
                                ...
                                <li class="hidden"><img src="<?php _esc($config['site_url']);?>includes/assets/plugins/flags/images/<?php _esc($user_country);?>.png" alt=""> <?php _esc($user_country_name);?></li>
                                ...
                                <div class="bids-content dashboard-box-list">
                                    ...
                                    <div class="freelancer-name">
                                        <h4><a href="<?php url("PROFILE") ?>/<?php _esc($bid['username']);?>"><?php _esc($bid['name']);?></a>
                                            <div class="flag flag-vn" data-tippy-placement="top" title="<?php _esc($bid['country']);?>"></div>
                                            <?php
                                    ...
                                    data-chatid="'._esc($bid['user_id'],false).'_'._esc($item_id,false).'_project"
        ...
        <div class="col-xl-4 col-lg-4">
            <div class="sidebar-container">
                ...
                <div class="sidebar-widget">
                    ...
                    <!-- Bookmark Button -->
                    <button class="bookmark-button fav-button margin-bottom-25 set-item-fav <?php if($item_favorite == '1') { echo 'added'; }?>" data-item-id="<?php _esc($item_id)?>" data-userid="<?php _esc($user_id)?>" data-post-type="project" data-action="setFavAd">
