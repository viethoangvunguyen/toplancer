...
<form method="get" action="<?php url("LISTING") ?>" name="locationForm" id="ListingForm">
                    ...
                    <div class="intro-banner-search-form listing-page margin-top-30">
                        ...
                        <div class="intro-search-field">
                            <input id="keywords" type="text" name="keywords"
                                placeholder="<?php _e("Job Title or Keywords") ?>" value="<?php _esc($keywords) ?>">
                        </div>
                        <div class="intro-search-field with-autocomplete">
                            <div class="input-with-icon">
                                <input type="text" id="searchStateCity" name="location"
                                    placeholder="<?php _e("Where?") ?>">
    ...
    <div class="zoom-anim-dialog mfp-hide popup-dialog big-dialog" id="citiesModal">
        <div class="popup-tab-content padding-0">
            <div class="quick-states" id="country-popup" data-country-id="<?php _esc($default_country_id) ?>"
                style="display: block;">
                            ...
                            <div class="rel input-container">
                                <div class="input-with-icon">
                                    <input id="inputStateCity" class="with-border" type="text"
                                        placeholder="<?php _e("Type your city name") ?>">
                ...
                <div class="sidebar-container search-sidebar">
                    ...
                    <div class="sidebar-widget">
                        ...
                        <ul>
                            ...
                            <li>
                                <div class="checkbox">
                                    <input type="checkbox" id="job_type_<?php _esc($posttype['id']) ?>" name="job-type"
                                        value="<?php _esc($posttype['id']) ?>"
                                        <?php if($job_type == $posttype['id']) { echo "checked"; }?>>
                                    <label for="job_type_<?php _esc($posttype['id']) ?>"><span
                                            class="checkbox-icon"></span> <?php _esc($posttype['title']) ?></label>
                                </div>
                            </li>
                            <?php }?>
                        </ul>
                    ...
                    <div class="sidebar-widget">
                        ...
                        <ul>
                            ...
                            <li>
                                <div class="checkbox">
                                    <input type="checkbox" id="salary_type_<?php _esc($salarytype['id']) ?>"
                                        name="salary-type" value="<?php _esc($salarytype['id']) ?>"
                                        <?php if($salary_type == $salarytype['id']) { echo "checked"; }?>>
                                    <label for="salary_type_<?php _esc($salarytype['id']) ?>"><span
                                            class="checkbox-icon"></span> <?php _esc($salarytype['title']) ?></label>
                                </div>
                            </li>
                            <?php }?>
                        </ul>
                    ...
                    <div class="sidebar-widget">
                        ...
                        <div class="range-widget">
                            <div class="range-inputs">
                                <input type="text" placeholder="<?php _e("Min") ?>" name="range1"
                                    value="<?php _esc($range1) ?>">
                                <input type="text" placeholder="<?php _e("Max") ?>" name="range2"
                                    value="<?php _esc($range2) ?>">
                            </div>
                ...
                <div class="notify-box margin-top-15">
                    ...
                    <div class="sort-by">
                        ...
                        <select class="selectpicker hide-tick" id="sort-filter">
                            <option data-filter-type="sort" data-filter-val="id" data-order="desc"><?php _e("Newest") ?>
                            </option>
                            <option data-filter-type="sort" data-filter-val="title" data-order="desc">
                                <?php _e("Name") ?></option>
                            <option data-filter-type="sort" data-filter-val="date" data-order="desc"><?php _e("Date") ?>
                            </option>
                        </select>
                    </div>
                </div>
                ...
                <div class="listings-container margin-top-35">
                    ...
                    <div class="job-listing <?php if($item['highlight']){ echo 'highlight';}?>">
                        ...
                        <div class="job-listing-footer with-icon">
                            ...
                            <span class="fav-icon set-item-fav <?php if($item['favorite']) { echo 'added'; }?>"
                                data-item-id="<?php _esc($item['id'])?>" data-userid="<?php _esc($user_id)?>"
                                data-post-type="job" data-action="setFavAd"></span>
                            <?php }?>
                        </div>
                    </div>
                    <?php } ?>
