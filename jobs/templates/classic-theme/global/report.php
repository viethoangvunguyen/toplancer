    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                <span class="help-block" style="width: 50%;"> Hãy tìm hiểu kỹ về nhà tuyển dụng và công việc bạn ứng
                    tuyển. Bạn nên cẩn trọng với những công việc yêu cầu nộp phí, hoặc những hợp đồng mập mờ, không rõ
                    ràng. Nếu bạn thấy rằng tin tuyển dụng này không đúng, hãy phản ánh với chúng tôi.</span>
                <!-- Breadcrumbs -->
        ...
        <div class="col-xl-8 margin-0-auto">
            <div class="user-account clearfix">
                <form action="#" method="post">
                    ...
                    <div class="submit-field">
                        <h5><?php _e("Type") ?> <?php _e("Violation") ?></h5>
                        <select name="violation" class="selectpicker with-border">
                            <option><?php _e("Chọn") ?></option>
                            <option value="<?php _e("Posting contact information") ?>">
                                <?php _e("Posting contact information") ?></option>
                            <option value="<?php _e("Advertising another website") ?>">
                                <?php _e("Advertising another website") ?></option>
                            <option value="<?php _e("Fake job posted") ?>"><?php _e("Fake job posted") ?></option>
                            <option value="<?php _e("Non-featured job posted requiring abnormal bidding") ?>">
                                <?php _e("Non-featured job posted requiring abnormal bidding") ?></option>
                    ...
                    <button type="submit" name="Submit" id="submit"
                        class="button"><?php _e("Report Violation") ?></button>
                </form>
                <!-- checkbox -->
            </div>
        </div>
