        ...
        <div class="col-xl-8 col-lg-8">
            ...
            <div class="blog-post single-post">
                ...
                <div class="blog-post-thumbnail">
                    <div class="blog-post-thumbnail-inner">
                        ...
                        <img src="<?php _esc($config['site_url']);?>storage/blog/<?php _esc($image);?>"
                            alt="<?php _esc($title);?>">
                        <?php } ?>
                        ...
                        <div class="share-buttons-content">
                            ...
                            <ul class="share-buttons-icons">
                                ...
                                <li><a href="https://web.whatsapp.com/send?text={BLOG_LINK}" data-button-color="#25d366"
                                        title="<?php _e("Share on WhatsApp") ?>" data-tippy-placement="top"
                                        rel="nofollow" target="_blank"><i class="fa fa-whatsapp"></i></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div id="comments">
                ...
                <div class="blog-widget">
                    <h3 class="widget-title margin-bottom-25"><?php _e("Comments") ?> (<?php _esc($comments_count) ?>)
                    </h3>
                        ...
                        <ul>
                            ...
                            <li id="li-comment-<?php _esc($comment['id']) ?>"
                                ...
                                <div class="comments-box" id="comment-<?php _esc($comment['id']) ?>">
                                    <div class="avatar">
                                        <img src="<?php _esc($config['site_url']);?>storage/profile/<?php _esc($comment['avatar']) ?>"
                                            alt="<?php _esc($comment['name']) ?>">
                                    </div>
                                    <div class="comment-content">
                                        ...
                                        <div class="comment-by">
                                            ...
                                            <a class="reply comments-reply comment-reply-link" href="javascript:void(0)"
                                                data-commentid="<?php _esc($comment['id']) ?>"
                                                data-postid="<?php _esc($blog_id) ?>"
                                                data-belowelement="comment-<?php _esc($comment['id']) ?>"
                                                data-respondelement="respond"><i
                                                    class="fa fa-reply"></i><?php _e("Reply") ?></a>
                                            <?php } ?>
                                        </div>
                    ...
                    <div>
                        ...
                        <form action="#respond" method="post" id="commentform" class="blog-comment-form">
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="commenting-as">
                                        ...
                                        <select id="commenting-as" name="commenting-as"
                                            ...
                                            <option value="admin"><?php _esc($admin_username) ?> (<?php _e("Admin") ?>)
                                            </option>
                                ...
                                <div class="col-md-12">
                                    <p><?php _e("You are commenting as:") ?>
                                        <strong><?php _esc($admin_username) ?></strong> (<?php _e("Admin") ?>)
                                    </p>
                                </div>
                                <?php }
                                        else if($is_login){ ?>
                                <div class="col-md-12">
                                    <p><?php _e("You are commenting as:") ?> <strong><?php _esc($username) ?></strong>
                                    </p>
                                </div>
                                <?php } ?>
                                <?php if($is_login || $admin_logged_in) { ?>
                                    <div class="col-md-12">
                                        <textarea rows="5" id="comment-field" name="comment"
                                            placeholder="<?php _e("Your comment...") ?>" required></textarea>
                                        <button type="submit" name="comment-submit"
                                            class="button ripple-effect"><?php _e("Submit") ?></button>
                                        <input type="hidden" name="comment_parent" id="comment_parent" value="0">
                                        <input type="hidden" name="comment_post_ID" value="<?php _esc($blog_id) ?>"
                                            id="comment_post_ID">
                                    </div>
                                <?php } else {?>
                                    <div class="col-md-12">
                ...
                <form action="<?php url("BLOG") ?>">
                    <div class="sidebar-widget margin-bottom-40">
                        <div class="input-with-icon">
                            <input type="text" placeholder="<?php _e("Search") ?>..." name="s" id="search-widget">
                    ...
                    <ul class="widget-tabs">
                        ...
                        <li>
                            <a href="<?php _esc($recent_blogs['link']) ?>"
                                class="widget-content <?php _esc($recent_blogs['class']) ?>">
                                <?php
                        ...
                        <div class="single-testimonial">
                            <div class="single-inner">
                                ...
                                <div class="testi-author-info">
                                    <div class="image"><img
                                            src="<?php _esc($config['site_url']);?>storage/testimonials/<?php _esc($testimonial['image']) ?>"
                                            alt="<?php _esc($testimonial['name']) ?>"></div>
