<?php
overall_header(__("Favourite Jobs"));
?>
<!-- Dashboard Container -->
    ...
    <div class="dashboard-content-container" data-simplebar>
        <div class="dashboard-content-inner" >
            ...
            <div class="dashboard-headline">
                <h3><?php _e("Favourite Jobs") ?></h3>
                <!-- Breadcrumbs -->
                <nav id="breadcrumbs" class="dark">
                    <ul>
                        <li><a href="<?php url("INDEX") ?>"><?php _e("Home") ?></a></li>
                        <li><?php _e("Favourite Jobs") ?></li>
                    </ul>
                </nav>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-xl-12">
                    <div class="dashboard-box margin-top-0">
                        <!-- Headline -->
                        <div class="headline">
                            <h3><i class="icon-feather-heart"></i> <?php _e("Favourite Jobs") ?></h3>
                        </div>
                        <?php
                        if(!$totalitem) {
                            echo '<div class="content with-padding text-center">'.__("No favourite jobs found.").'</div>';
                        }
                        ?>
                    </div>
                            ...
                            <div class="job-listing fav-listing">
                                <div class="job-listing-details">
                                    ...
                                    <div class="job-listing-description">
                                        ...
                                        <?php } ?>
                                        <h3 class="job-listing-title"><a href="<?php _esc($item['link'])?>"><?php _esc($item['product_name'])?></a></h3>
                                ...
                                <div class="job-listing-footer with-icon">
                                    ...
                                    <span class="fav-icon added set-item-fav" data-item-id="<?php _esc($item['id'])?>" data-userid="<?php _esc($user_id)?>" data-post-type="job" data-action="removeFavAd"></span>
                                </div>
                            </div>
                        <?php } ?>
                        <!-- Pagination -->
