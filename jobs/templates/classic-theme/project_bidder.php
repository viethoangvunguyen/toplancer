    ...
    <div class="dashboard-content-container" data-simplebar>
        <div class="dashboard-content-inner">
            ...
            <div class="dashboard-headline">
                <h3>Đề xuất giá thầu</h3>
                <span class="margin-top-7"><?php _e("Bids") ?> <?php _e("for") ?> <a
                        href="<?php _esc($project_link)?>"><?php _esc($project_name)?></a></span>
                <!-- Breadcrumbs -->
            ...
            <div class="row">
                ...
                <div class="col-xl-12">
                    <div class="dashboard-box">
                        <!-- Content Start -->
                        <div class="headline">
                            <h3><i class="icon-material-outline-supervisor-account"></i> <?php _esc($totalitem)?>
                                <?php _e("Proposals") ?> </h3>
                        </div>
                        ...
                        <div class="content">
                            <ul class="dashboard-box-list">
                                ...
                                <li class="ajax-item-listing <?php if($bid['user_id'] == $bid['freelancer_id']){ echo 'awarded'; } ?>"
                                    data-item-id="<?php _esc($bid['id'])?>">
                                    <div class="bid">
                                        <!-- Avatar -->
                                        <div class="bids-avatar">
                                            <div class="freelancer-avatar">
                                                ...
                                                <a href="<?php url("PROFILE") ?>/<?php _esc($bid['username'])?>">
                                                    <img src="<?php _esc($config['site_url'])?>storage/profile/<?php _esc($bid['image'])?>"
                                                        alt="<?php _esc($bid['name'])?>">
                                                </a>
                                            </div>
                                        </div>
                                        ...
                                        <div class="bids-content dashboard-box-list">
                                            ...
                                            <div class="freelancer-name">
                                                <h4><a
                                                        href="<?php url("PROFILE") ?>/<?php _esc($bid['username'])?>"><?php _esc($bid['name'])?></a>
                                                    <div class="flag flag-vn"
                                                        data-tippy-placement="top"
                                                        title="<?php _esc($bid['country'])?>"></div>
                                                    <?php
                                                ...
                                                <div class="star-rating" data-rating="<?php _esc($bid['rating'])?>">
                                                </div><br>
                                                <?php } ?>

                                                <div
                                                    class="margin-top-20 <?php if($bid['showmore'] == '1'){ echo 'show-more'; } ?>">
                                                    <?php _esc($bid['description'])?>
                                                    <?php if($bid['showmore'] == '1'){ ?> <a href="#"
                                                        class="show-more-button"><?php _e("Show More") ?> <i
                                                            class="fa fa-angle-down"></i></a> <?php } ?>
                                                </div>
                                                <!-- Buttons -->
                                                <div
                                                    ...
                                                    <?php
                                                        ...
                                                        if($config['quickchat_socket_on_off'] == "on" || $config['quickchat_ajax_on_off'] == "on"){
                                                           ...
                                                           data-chatid="'._esc($bid['user_id'],false).'_'._esc($project_id,false).'_project"
                                        ...
                                        <div class="bids-bid">
                                            <div class="bid-rate">
                                                ...
                                                <span><?php _e("in") ?> <?php _esc($bid['days'])?>
                                                    <?php _e("days") ?></span>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="popup-tabs-container">
                        ...
                        <div class="popup-tab-content" id="tab">
                            <form id="accept-bid-form" method="post" action="#">
                                ...
                                <!-- Button -->
                                <button id="accept-bid-button"
                                    class="margin-top-15 button full-width button-sliding-icon ripple-effect"
                                    type="submit"> Đồng ý <i class="icon-material-outline-arrow-right-alt"></i></button>
                            </form>
                        </div>
