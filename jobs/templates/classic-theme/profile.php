...
<div class="single-page-header freelancer-header"
    data-background-image="<?php _esc(TEMPLATE_URL);?>/images/single-freelancer.jpg">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="single-page-header-inner">
                    <div class="left-side">
                        <div class="header-image freelancer-avatar"><img
                                src="<?php _esc($config['site_url']);?>storage/profile/<?php _esc($userimage);?>"
                                alt="<?php _esc($fullname);?>"></div>
                        <div class="header-details">
                            <h3><?php _esc($fullname);?> @<?php _esc($profileusername);?>
                                <span><?php _e("Member Since:") ?>
                                    <?php _esc(Date('d/m/Y',strtotime($created)));?></span>
                            </h3>
                            <ul>
                                <li>
                                    <div class="star-rating" data-rating="<?php _esc($average_rating);?>"></div>
                                </li>
                                <li><img class="flag" style="height: 40px; width: auto;" src="<?php _esc($badge);?>"
                                        alt="">
                                </li>
                                <?php if($userstatus == "1"){
        ...
        <div class="col-xl-8 col-lg-8 content-right-offset">
                    ...
                    <div class="job-listing">
                        <div class="job-listing-details">
                            <div class="job-listing-description">
                                ...
                                <p class="job-listing-text read-more-toggle" data-read-more="<?php _e("Read more") ?>"
                                    data-read-less="<?php _e("Read less") ?>"><?php _esc($experience['description']);?>
                                </p>
                            </div>
                        </div>
            ...
            <div class="boxed-list margin-bottom-60">
                ...
                <div class="listings-container compact-list-layout starReviews">
                    ...
                    <div id="review-productId" class="review-productId" style="display: none"
                        data-review-type="project"><?php _esc($userid);?></div>
                    ...
                    <script
                        src="//cdnjs.cloudflare.com/ajax/libs/jquery-form-validator/2.1.34/jquery.form-validator.min.js">
                    </script>
                    <!-- jQuery Barrating plugin -->
                    <script src="<?php _esc($config['site_url']);?>plugins/starreviews/assets/js/jquery.barrating.js">
                    </script>
                    <!-- jQuery starReviews -->
                    <script src="<?php _esc($config['site_url']);?>plugins/starreviews/assets/js/starReviews.js">
                    </script>
                    <script type="text/javascript">
            ...
            <div class="sidebar-container">
                ...
                <div class="profile-overview">
                    <div class="overview-item">
                        <strong><?php _esc($win_project)?></strong><span><?php _e("Won Bid") ?></span>
                    </div>
                </div>
                ...
                <div class="sidebar-widget">
                    <div class="freelancer-indicators">
                        ...
                        <div class="indicator">
                            ...
                            <div class="indicator-bar" data-indicator-percentage="<?php _esc($project_completed)?>">
                                <span></span>
                            </div>
                        ...
                        <div class="indicator">
                            ...
                            <div class="indicator-bar"
                                data-indicator-percentage="<?php _esc($recommendation_percentage)?>"><span></span></div>
                        ...
                        <div class="indicator">
                            ...
                            <div class="indicator-bar" data-indicator-percentage="<?php _esc($on_budget_percentage)?>">
                                <span></span>
                            </div>
                        ...
                        <div class="indicator">
                            ...
                            <div class="indicator-bar" data-indicator-percentage="<?php _esc($on_time_percentage)?>">
                                <span></span>
                            </div>
...
if($is_login) {
        ...
        echo '<a href="' . _esc($quickchat_url, false) . '" 
                ...
                <div class="sidebar-widget">
                    ...
                    <!-- Bookmark Button -->
                    <button
                        class="bookmark-button fav-button margin-bottom-25 set-user-fav <?php if($user_favorite == '1'){ echo 'added'; } ?>"
                        data-favuser-id="<?php _esc($userid)?>" data-userid="<?php _esc($user_id)?>"
                        data-action="setFavUser">
                    ...
                    <div class="copy-url">
                        ...
                        <button class="copy-url-button ripple-effect" data-clipboard-target="#copy-url"
                            title="<?php _e("Copy to Clipboard") ?>" data-tippy-placement="top"><i
                    ...
                    <div class="share-buttons margin-top-25">
                        ...
                        <div class="share-buttons-content">
                            ...
                            <ul class="share-buttons-icons">
                                <li><a href="mailto:?subject=<?php _esc($username)?>&body=<?php _esc($item_link)?>"
                                        data-button-color="#dd4b39" title="<?php _e("Share on Email") ?>"
                                        data-tippy-placement="top" rel="nofollow" target="_blank"><i
                                            class="fa fa-envelope"></i></a></li>
                                <li><a href="https://facebook.com/sharer/sharer.php?u=<?php _esc($item_link)?>"
                                        data-button-color="#3b5998" title="<?php _e("Share on Facebook") ?>"
                                        data-tippy-placement="top" rel="nofollow" target="_blank"><i
                                            class="icon-brand-facebook-f"></i></a></li>
                                <li><a href="https://twitter.com/share?url=<?php _esc($item_link)?>&text=<?php _esc($item_title)?>"
                                        data-button-color="#1da1f2" title="<?php _e("Share on Twitter") ?>"
                                        data-tippy-placement="top" rel="nofollow" target="_blank"><i
                                            class="fa fa-twitter"></i></a></li>
                                <li><a href="https://www.linkedin.com/shareArticle?mini=true&url=<?php _esc($item_link)?>"
                                        data-button-color="#0077b5" title="<?php _e("Share on LinkedIn") ?>"
                                        data-tippy-placement="top" rel="nofollow" target="_blank"><i
                                            class="fa fa-linkedin"></i></a></li>
                                <li><a href="https://pinterest.com/pin/create/bookmarklet/?&url=<?php _esc($item_link)?>&description=<?php _esc($item_title)?>"
                                        data-button-color="#bd081c" title="<?php _e("Share on Pinterest") ?>"
                                        data-tippy-placement="top" rel="nofollow" target="_blank"><i
                                            class="fa fa-pinterest-p"></i></a></li>
                                <li><a href="https://web.whatsapp.com/send?text=<?php _esc($item_link)?>"
                                        data-button-color="#25d366" title="<?php _e("Share on WhatsApp") ?>"
                                        data-tippy-placement="top" rel="nofollow" target="_blank"><i
