                    ...
                    <div class="intro-banner-search-form listing-page margin-top-30">
                        ...
                        <div class="intro-search-field">
                            <input id="keywords" type="text" name="keywords"
                                placeholder="<?php _e("Project Title or Keywords") ?>" value="<?php _esc($keywords) ?>">
                        </div>
                ...
                <div class="sidebar-container search-sidebar">
                    <div class="sidebar-widget">
                        ...
                        <ul>
                            <li>
                                <div class="radio">
                                    <input id="fixed_price" name="salary-type" type="radio" value="0"
                                        <?php if($salary_type == "0") { echo "checked"; }?>>
                                    <label for="fixed_price"><span class="radio-label"></span>
                                        <?php _e("Fixed Price") ?></label>
                                </div>
                            </li>
                            <li>
                                <div class="radio">
                                    <input id="hourly_price" name="salary-type" type="radio" value="1"
                                        <?php if($salary_type == "1") { echo "checked"; }?>>
                                    <label for="hourly_price"><span class="radio-label"></span>
                                        <?php _e("Hourly Price") ?></label>
                                </div>
                            </li>
                        </ul>
                    </div>
                    ...
                    <a href="<?php _esc($item['link'])?>" class="task-listing">
                        ...
                        <div class="task-listing-details">
                            ...
                            <div class="task-listing-description">
                                ...
                                <ul class="task-icons">
                                    <li><i class="icon-material-outline-gavel"></i> <?php _esc($item['bids_count'])?>
                                        <?php _e("Bids") ?></li>
                                    <li><i class="icon-material-outline-access-time"></i>
                                        <?php _esc($item['created_at'])?></li>
                                </ul>
