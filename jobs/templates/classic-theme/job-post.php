<?php overall_header(__("Post Free Job")); ?>
                    ...
                    <div class="popup-tab-content" id="exist_acc" style="">
                        <form accept-charset="utf-8" id="email_exists_login">
                            <p id="email_exists_success" style="display: none;">
                                <span
                                    class="status-available"><?php _e("Account Linked Successful. Redirecting...") ?></span>
                            </p>

                            <p><span id="quickad_email_already_linked"></span>
                                <br><?php _e("Enter your password below to link accounts:") ?>
                            </p>
                        ...
                        <div id="email_exists_user">
                            <p><?php _e("The email address you entered is linked with a Job Seeker account. Please change the email address or login with an Employer account") ?>
                            </p>
    ...
    <div class="container">
        <div class="row">
            <div class="col-xl-8 col-md-12">
                ...
                <form id="post_job_form" action="<?php url("POST-JOB") ?>?action=post_job" method="post"
                                ...
                                <div class="col-xl-12">
                                    <div class="submit-field">
                                        ...
                                        <select id="company-select" class="selectpicker with-border"
                                            title="<?php _e("Select") ?> <?php _e("Company") ?>" data-size="7"
                                            name="company">

                                            <?php foreach ($companies as $company){ ?>
                                            <option value="<?php _esc($company['id'])?>"><?php _esc($company['title'])?>
                                            </option>
                                            <?php } ?>
                                ...
                                <div class="col-xl-12">
                                    <div class="form-group text-center">
                                        <a href="#categoryModal" id="choose-category"
                                            class="button popup-with-zoom-anim"><i
                                                class="icon-feather-check-circle"></i>
                                    ...
                                    <div class="submit-field">
                                        ...
                                        <select class="selectpicker with-border" data-size="7" name="job_type">
                                            ...
                                            foreach ($posttypes as $posttype){
                                                echo '<option value="'._esc($posttype['id'],false).'">'._esc($posttype['title'],false).'</option>';
                                            } ?>
                                        </select>
                                    </div>
                                    <div class="submit-field">
                                        ...
                                        <div class="row">
                                            <div class="col-xl-4 col-md-12">
                                                <div class="input-with-icon">
                                                    <input class="with-border" type="text"
                                                        placeholder="<?php _e("Min") ?>" name="salary_min">
                                            ...
                                            <div class="col-xl-4 col-md-12">
                                                <div class="input-with-icon">
                                                    <input class="with-border" type="text"
                                                        placeholder="<?php _e("Max") ?>" name="salary_max">
                                                    <i class="currency"><?php _esc($user_currency_sign)?></i>
                                                </div>
                                            </div>
                                            <div class="col-xl-4 col-md-12">
                                                <select class="selectpicker with-border margin-bottom-16" data-size="7"
                                                    ...
                                                    foreach ($salarytypes as $salarytype){
                                                        echo '<option value="'._esc($salarytype['id'],false).'" >'._esc($salarytype['title'],false).'</option>';
                                                    } ?>
                                                </select>
                                            </div>
                                            <div class="col-xl-12">
                                            ...
                                            <div class="col-xl-6 col-md-12">
                                                <div class="input-with-icon-left">
                                                    <i class="flag-img"><img
                                                            src="<?php _esc($config['site_url'])?>includes/assets/plugins/flags/images/<?php _esc($user_country)?>.png"></i>
                                    ...
                                    <div class="submit-field">
                                        ...
                                        <div class="input-with-icon">
                                            <div id="autocomplete-container"
                                                data-autocomplete-tip="<?php _e("type and hit enter") ?>">
                                                <input class="with-border" type="text"
                                                    placeholder="<?php _e("Address") ?>" name="location"
                        ...
                        <div class="content with-padding">
                            <div class="payment">
                                ...
                                <div class="payment-tab">
                                    ...
                                    <div class="payment-tab-content">
                                        <p><?php _e("You can optionally select some upgrades to get the best results.") ?>
                                        </p>
                                        ...
                                        <div class="row premium-plans">
                                            ...
                                            <div class="col-lg-3 premium-plans-price">
                                                <?php _esc($featured_fee)?> <?php _esc($user_currency_sign)?>
                                                <?php _e("for") ?> <?php _esc($featured_duration)?> <?php _e("days") ?>
                                            </div>
                                        </div>
                                        <div class="row premium-plans">
                                            <div class="col-lg-3">
                                            ...
                                            <div class="col-lg-3 premium-plans-price">
                                                <?php _esc($urgent_fee)?> <?php _esc($user_currency_sign)?>
                                                <?php _e("for") ?> <?php _esc($urgent_duration)?> <?php _e("days") ?>
                                            </div>
                                        </div>
                                        <div class="row premium-plans">
                                            <div class="col-lg-3">
                                            ...
                                            <div class="col-lg-3 premium-plans-price">
                                                <?php _esc($highlight_fee)?> <?php _esc($user_currency_sign)?>
                                                <?php _e("for") ?> <?php _esc($highlight_duration)?> <?php _e("days") ?>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="row margin-top-30 margin-bottom-80" style="align-items: center;">
                        <div class="col-6">
                            <button type="submit" id="submit_job_button" name="Submit" class="button ripple-effect big">
                                <i class="icon-feather-plus"></i> <?php _e("Post a Job") ?></button>
                        </div>
                        <div class="col-6">
...
<script src="//cdnjs.cloudflare.com/ajax/libs/select2/4.0.2-rc.1/js/i18n/<?php _esc($config['lang_code']) ?>.js">
</script>
...
<link media="all" rel="stylesheet" type="text/css"
    href="<?php _esc($config['site_url'])?>includes/assets/plugins/simditor/styles/simditor.css" />
...
if($config['post_address_mode']){
    if($config['map_type']=="google"){
        ?>
<link href="<?php _esc($config['site_url'])?>includes/assets/plugins/map/google/map-marker.css" type="text/css"
    rel="stylesheet">
<script type='text/javascript'
    src='<?php _esc($config['site_url'])?>includes/assets/plugins/map/google/jquery-migrate-1.2.1.min.js'></script>
<script type='text/javascript'
    src='//maps.google.com/maps/api/js?key=<?php _esc($config['gmap_api_key'])?>&#038;libraries=places%2Cgeometry&#038;ver=2.2.1'>
</script>
<script type='text/javascript'
...
<script type='text/javascript' src='<?php _esc($config['site_url'])?>includes/assets/plugins/map/google/gmapAdBox.js'>
</script>
<script type='text/javascript' src='<?php _esc($config['site_url'])?>includes/assets/plugins/map/google/maps.js'>
</script>
<script>
...
<script src="<?php _esc($config['site_url'])?>includes/assets/plugins/map/openstreet/leaflet-markercluster.min.js">
</script>
<script src="<?php _esc($config['site_url'])?>includes/assets/plugins/map/openstreet/leaflet-gesture-handling.min.js">
</script>
...
<script src="<?php _esc($config['site_url'])?>includes/assets/plugins/map/openstreet/leaflet-control-geocoder.js">
</script>
<script>
$('#jobcity').on('change', function() {
    var data = $("#jobcity option:selected").val();
