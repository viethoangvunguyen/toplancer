...
<head>
    ...
    <style>
    :root {
        <?php $themecolor=$config['theme_color'];
        $colors=array();
    ...
    <?php if($lang_direction == 'rtl') {
        ...
        echo '<link rel="stylesheet" href="'.TEMPLATE_URL.'/css/style.css?ver='.'1.0.2'.'">';
    }?>
...
<body data-role="page" class="<?php _esc($lang_direction);?>" id="page"
    data-ipapi="<?php _esc($config['live_location_api']);?>"
    data-showlocationicon="<?php _esc($config['location_track_icon']);?>">
    <!--[if lt IE 8]>
...
<![endif]-->
    ...
    <div class="zoom-anim-dialog mfp-hide popup-dialog big-dialog" id="citiesModal">
        <div class="popup-tab-content padding-0">
            <div class="quick-states" id="country-popup" data-country-id="<?php _esc($country_code);?>"
                style="display: block;">
                <div id="regionSearchBox" class="title clr">
                    <div class="clr">
                        <div class="locationrequest smallBox br5 col-sm-4">
                            <div class="rel input-container">
                                <div class="input-with-icon">
                                    <input id="inputStateCity" class="with-border" type="text"
                                        placeholder="<?php _e("Search city") ?>">
                            ...
                            <div id="lastUsedCities" class="last-used binded" style="display: none;">
                                <?php _e("Popular cities") ?>
                        ...
                        <span style="line-height: 30px;">
                            <span class="flag flag-<?php _esc($user_country);?>"></span> <a href="#countryModal"
                                class="popup-with-zoom-anim"><?php _e("Change Country") ?></a>
                        </span>
                        <?php } ?>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="input-with-icon margin-bottom-30">
                            <input class="with-border" type="text" placeholder="<?php _e("Search") ?>..."
                    ...
                    <ul id="countries" class="column col-md-12 col-sm-12 cities">
                        ...
                        <li data-name="<?php _esc($country['name']);?>">
                            ...
                            <a href="<?php url("HOME") ?>/<?php _esc($country['lang']);?>/<?php _esc($country['lowercase_code']);?>"
                                data-id="<?php _esc($country['id']);?>" data-name="<?php _esc($country['name']);?>">
                                <?php _esc($country['name']);?></a>
                        </li>
                        <?php } ?>
                    </ul>
                </div>
                            ...
                            if($config['country_type'] == 'multi'){
                                ...
                                <li>
                                    <a href="#countryModal" class="country-flag popup-with-zoom-anim"
                                        title="<?php _e("Change Country") ?>" data-tippy-placement="right">

                                        <img
                                            src="<?php _esc($config['site_url']);?>includes/assets/plugins/flags/images/<?php _esc($user_country);?>.png" />
                                    </a>
                                </li>
                                <?php } ?>
                                ...
                                <li><a href="#"><?php _e("") ?><?php _e("Find Work") ?></a>
                                    <ul class="dropdown-nav">
                                        <li><a href="<?php url("SEARCH_PROJECTS") ?>"><?php _e("Browse Projects") ?></a>
                                        </li>
                                ...
                                <li><a href="#"><?php _e("") ?><?php _e("For Employers") ?></a>
                                    <ul class="dropdown-nav">
                                        <li><a href="<?php url("POST-PROJECT") ?>"><?php _e("Post a Project") ?></a>
                                        </li>
                                        <li><a href="<?php url("POST-JOB") ?>"><?php _e("Post a Job") ?></a></li>
                                        <?php
                                    if($config['job_seeker_enable']){
                                        ?>
                                        <li><a href="<?php url("FREELANCERS") ?>"><?php _e("Find Freelancers") ?></a>
                                        </li>
                                        <?php
                                    }?>
                                    </ul>
                        ...
                        <div class="header-widget hide-on-mobile">
                            ...
                            <div class="header-notifications padding-0">
                                ...
                                <div class="header-notifications-dropdown">
                                    ...
                                    <div class="header-notifications-headline">
                                        ...
                                        <button class="hidden mark-as-read ripple-effect-dark" title="Mark all as read"
                                            ...
                                            <ul>
                                                ...
                                                <li class="notifications-not-read">
                                                    ...
                                                    <a href="<?php url("MILESTONE") ?>/<?php _esc($id) ?>">
                                                        ...
                                                        <span
                                                            class="notification-text"><strong><?php _esc($sender) ?></strong>
                                                            <?php _e("created a milestone") ?> <?php _esc($msg) ?>
                                                            <?php _e("for") ?> <span
                                                                class="color"><?php _esc($title) ?></span></span>
                                                    </a>
                                                    <?php }
                                                    ...
                                                    <a href="<?php url("MILESTONE") ?>/<?php _esc($id) ?>">
                                                        ...
                                                        <span
                                                            class="notification-text"><strong><?php _esc($sender) ?></strong>
                                                            <?php _e("Request for release") ?> <?php _e("Milestone") ?>
                                                            <?php _esc($msg) ?> <?php _e("for") ?> <span
                                                                class="color"><?php _esc($title) ?></span></span>
                                                    </a>
                                                    <?php }
                                                    ...
                                                    <a href="<?php url("MILESTONE") ?>/<?php _esc($id) ?>">
                                                        ...
                                                        <span
                                                            class="notification-text"><strong><?php _esc($sender) ?></strong>
                                                            <?php _e("Milestone") ?> <?php _e("Released") ?>
                                                            <?php _esc($msg) ?> <?php _e("for") ?> <span
                                                                class="color"><?php _esc($title) ?></span></span>
                                                    </a>
                                                    <?php }
                                                    ...
                                                    <a href="javascript:void(0);">
                                                        <span class="notification-icon"><i
                                                                class="icon-material-outline-monetization-on"></i></span>
                                                        <span
                                                            class="notification-text"><strong><?php _esc($sender) ?></strong>
                                                            <?php _e("Deposit") ?> <?php _esc($msg) ?> <?php _e("to") ?>
                                                            <span class="color"><?php _e("Wallet") ?></span></span>
                                                    </a>
                                                    ...
                                                    <a href="<?php url("SERVICE") ?>/<?php _esc($id) ?>">
                                                        ...
                                                        <span
                                                            class="notification-text"><strong><?php _esc($sender) ?></strong>
                                                            <?php _e("New") ?> <?php _esc($msg) ?> <?php _e("for") ?>
                                                            <span class="color"><?php _esc($title) ?></span></span>
                                                    </a>
                                                    <?php } else{ ?>
                                                    <a href="#">
                                                        <span class="notification-icon"><i
                                    ...
                                    <a href="<?php url("NOTIFICATIONS") ?>"
                                        class="header-notifications-button ripple-effect button-sliding-icon"><?php _e("View All") ?><i
                            ...
                            <div class="header-notifications hidden">
                                ...
                                <div class="header-notifications-dropdown">
                                            ...
                                            <ul>
                                                ...
                                                <li class="notifications-not-read">
                                                    <a href="<?php url("MESSAGE") ?>">
                                                        <span
                                                            class="notification-avatar status-<?php _esc($msg['status']) ?>"><img
                                                                src="<?php _esc($config['site_url']);?>storage/profile/<?php _esc($msg['image']) ?>"
                                                                alt=""></span>
                                                        <div class="notification-text">
                                                            <strong><?php _esc($msg['from_name']) ?></strong><br>
                                                            <div class="zechat-message"><i
                                                                    class="fa fa-file-text-o"></i>
                                                                <?php _esc($msg['post_title']) ?>
                                                            </div>
                                                            <p class="notification-msg-text">
                                                                <?php _esc($msg['message']) ?></p><br>
                                    ...
                                    <a href="<?php url("MESSAGE") ?>"
                                        class="header-notifications-button ripple-effect button-sliding-icon"><?php _e("View All Messages") ?><i
                                            class="icon-material-outline-arrow-right-alt"></i></a>
                                </div>
                            </div>
                                ...
                                <div class="header-notifications-dropdown">
                                        ...
                                        <div class="user-details">
                                            ...
                                            <div class="user-name">
                                                <?php _esc($fullname);?> <span>
                                                    ...
                                                    _esc($usertype);
                                                    ?></span>
                                                <div class="dashboard-status-button balance yellow">
                                                    <?php _esc($balance);?><?php _esc($config['currency_sign'])?></div>
                                            </div>
                                            <div><img style="width: 40px;margin-left: 30px;margin-top: 20px;"
                                                    src="<?php _esc($badge);?>" alt=""></div>
                                    ...
                                    <ul class="user-menu-small-nav">
                                        ...
                                        if($config['quickchat_ajax_on_off'] == 'on' || $config['quickchat_socket_on_off'] == 'on'){
                                            ?>
                                        <li><a href="<?php url("MESSAGE") ?>"><i
                                                    class="icon-feather-message-circle"></i> <?php _e("Message") ?></a>
                                        </li>
                                        <?php } ?>
                        ...
                        <div class="header-widget d-none d-lg-block">
                            <nav id="navigation">
                                ...
                                if(!$is_login){
                                    ...
                                    <li><a href="<?php url("POST-PROJECT") ?>"
                                            class="button ripple-effect post-job"><?php _e("Post Project") ?></a>
                                    </li>
                                    <?php
                                }
