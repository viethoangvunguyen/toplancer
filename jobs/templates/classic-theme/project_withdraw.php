                    ...
                    <div class="dashboard-box margin-top-0">
                        ...
                        ?>
                                ...
                                <form name="form1" method="post" action="" id="send">
                                    <p class="alert alert-info"><i class="icon-info-sign"></i>
                                    ...
                                    <p>
                                        <span class="fs20 fbold"><?php _e("Withdraw Amount") ?> :
                                            <?php _esc($config['currency_sign'])?> </span>
                                    </p>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="input-with-icon margin-bottom-30">
                                                <input class="with-border" type="text"
                                                    placeholder="<?php _e("Amount") ?>" name="amount">
                                    ...
                                    <p>
                                        <span class="info no-mar"><i class="icon-info-sign"></i>
                                            <?php _e("Minimum withdraw amount") ?> :
                                            <?php _esc(price_format($config['payment_minimum_withdraw']))?></span><br>
                                    </p>
                                    <p>
                                    ...
                                    <div style="min-height:20px; margin-top:10px">
                                        ...
                                        <div class="radio">
                                            <input id="<?php _esc($payment['id']) ?>" name="payment_id" type="radio"
                                                value="<?php _esc($payment['id']) ?>">
                                            <label for="<?php _esc($payment['id']) ?>"><span class="radio-label"></span>
                                                <?php _esc($payment['title']) ?></label>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="margin-bottom-30">
                                                ...
                                                <textarea name="account_details" class="with-border"
                                                    placeholder="<?php _e("Write Payment Details...") ?>"></textarea>
                                            </div>
                                    ...
                                    <p class="margin-top-10">
                                        <button name="Submit" class="button"
                                            type="submit"><?php _e("Withdraw") ?></button>
                                    </p>
                                    <p>&nbsp;</p>
                                    <p class="fbold fs20"><?php _e("Widthdraw Requests") ?></p>
                                    <p>
                                        ...
                                        <table id="js-table-list" class="basic-table dashboard-box-list">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php _esc($info['amount']) ?><?php _esc($config['currency_sign'])?>
                                                    </td>
                                                ...
                                                <tr>
                                                    <td colspan="3" class="text-center"><?php _e("No result found.") ?>
                                                    </td>
                                                </tr>
                                                <?php } ?>
