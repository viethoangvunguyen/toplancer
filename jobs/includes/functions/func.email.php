...
function email_template($template, $user_id=null, $password=null, $product_id=null, $item_title=null){
    ...
    if($template == "banner_rejected"){
        /*User : banner request rejected*/
        $html = $config['email_sub_banner_rejected'];
        $html = str_replace ('{SITE_TITLE}', $config['site_title'], $html);
        $html = str_replace ('{SITE_URL}', $config['site_url'], $html);
        $html = str_replace ('{USER_ID}', $user_id, $html);
        $html = str_replace ('{USERNAME}', $username, $html);
        ...
        $html = $config['emailHTML_banner_rejected'];
        $html = str_replace ('{SITE_TITLE}', $config['site_title'], $html);
        $html = str_replace ('{SITE_URL}', $config['site_url'], $html);
        $html = str_replace ('{USER_ID}', $user_id, $html);
        $html = str_replace ('{AMOUNT}', $password.' '.$config['currency_code'], $html);
        $html = str_replace ('{URL}', $product_id, $html);
        $html = str_replace ('{DAYS_PURCHASED}', $item_title, $html);
        $html = str_replace ('{USERNAME}', $username, $html);
        $html = str_replace ('{EMAIL}', $user_email, $html);
        $html = str_replace ('{USER_FULLNAME}', $user_fullname, $html);
        $email_body = $html;
    ...
    if($template == "banner_accepted"){
        /*User : banner request accepted*/
        $html = $config['email_sub_banner_accepted'];
        $html = str_replace ('{SITE_TITLE}', $config['site_title'], $html);
        $html = str_replace ('{SITE_URL}', $config['site_url'], $html);
        $html = str_replace ('{USER_ID}', $user_id, $html);
        $html = str_replace ('{USERNAME}', $username, $html);
        ...
        $html = $config['emailHTML_banner_accepted'];
        $html = str_replace ('{SITE_TITLE}', $config['site_title'], $html);
        $html = str_replace ('{SITE_URL}', $config['site_url'], $html);
        $html = str_replace ('{USER_ID}', $user_id, $html);
        $html = str_replace ('{AMOUNT}', $password.' '.$config['currency_code'], $html);
