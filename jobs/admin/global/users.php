        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="pull-right">
                    <a href="#" data-url="panel/users_add.php" data-toggle="slidePanel" class="btn btn-success waves-effect waves-light m-r-10">Thêm Tài Khoản</a>
                </div>
            </div>
                ...
                <div id="js-table-list">
                    <table id="ajax_datatable" data-jsonfile="users.php" class="js-table-checkable table table-vcenter table-hover" data-tablesaw-mode="stack" data-plugin="animateList"
                        ...
                        <tr>
                            ...
                            <th style="width: 35%;" ><i class="ion-image"></i> Tài Khoản</th>
                            <th class="w-10">Loại</th>
                            <th class="w-10">Email</th>
                            <th style="width: 10%;" class="hidden-xs w-30" style="width: 100px;">Giới Tính</th>
                            <th style="width: 10%;" class="hidden-xs hidden-sm" style="width:100px">Trạng Thái</th>
                            <th style="width: 10%;" class="hidden-xs w-30" style="width: 100px;">Ngày Đăng Kí</th>
