                                        ...
                                        <div class="panel panel-default quickad-main">
                                            <div class="panel-body">
                                                <h4 class="quickad-block-head">
                                                    <span class="quickad-category-title">Danh Mục Blog </span>
                                                ...
                                                <form method="post" id="new-blog-cat-form" style="display: none">
                                                    <div class="form-group quickad-margin-bottom-md">
                                                        <div class="form-field form-required">
                                                            <label for="new-cat-name">Tiêu Đề</label>
...
<script src="../assets/js/blog-cat.js?1"></script>
<script src="../assets/js/alert.js?1"></script>
</body></html>