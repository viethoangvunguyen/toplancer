                ...
                <div id="js-table-list">
                    <table class="js-table-checkable table table-vcenter table-hover" id="ajax_datatable" data-jsonfile="blog-comments.php">
                        ...
                        <tr>
                            ...
                            <th class="hidden-xs sortingNone w-30">Bình Luận</th>
                            <th class="w-30">Bài Đăng</th>
                            <th style="width: 10%;" class="">Trạng Thái</th>
                            <th style="width: 10%;" class="hidden-xs hidden-sm">Thời Gian</th>
