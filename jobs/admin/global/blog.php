        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="pull-right">
                    <a class="btn btn-sm btn-success" href="blog-new.php">Thêm Mới</a>
                </div>
            </div>
                ...
                <div id="js-table-list">
                    <table class="js-table-checkable table table-vcenter table-hover" id="ajax_datatable" data-jsonfile="blog.php">
                        ...
                        <tr>
                            ...
                            <th style="width: 20%;" class="w-30">Tiêu Đề</th>
                            <th class="hidden-xs hidden-sm sortingNone">Nội Dung</th>
                            <th style="width: 9%;" class="hidden-xs hidden-sm">Tác Giả</th>
                            <th style="width: 9%;" class="hidden-xs hidden-sm sortingNone">Danh Mục</th>
                            <th class="hidden-xs">Trạng Thái</th>
                            <th class="hidden-xs hidden-sm">Lần Cuối Cập Nhật</th>
