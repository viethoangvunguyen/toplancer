        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="pull-right">
                    <a href="#" data-url="panel/admin_add.php" data-toggle="slidePanel" class="btn btn-success waves-effect waves-light m-r-10">Thêm Tài Khoản</a>
                </div>
            </div>
            <div class="card-block">
                <div id="js-table-list">
                    <table id="ajax_datatable" data-jsonfile="admins.php" class="js-table-checkable table table-vcenter table-hover" data-tablesaw-mode="stack" data-plugin="animateList" data-animate="fade" data-child="tr" data-selectable="selectable">
                        <thead>
                        <tr>
                            <th style="width: 5%;" class="text-center w-5 sortingNone">
                                <label class="css-input css-checkbox css-checkbox-default m-t-0 m-b-0">
                                    <input type="checkbox" id="check-all" name="check-all"><span></span>
                                </label>
                            </th>
                            <th style="width: 40%;"><i class="ion-image"></i> Tài Khoản</th>
                            <th style="width: 30%;" class="w-10">Email</th>
...
<div class="site-action">
    <button data-url="panel/admin_add.php" data-toggle="slidePanel" id="slidepanel-show" style="display: none;"> </button>
