...
$value = array(
    ...
    4 => '<td class="text-center">
                <div class="btn-group">
                    <a href="#" data-url="panel/membership_plan_edit.php?id=free" data-toggle="slidePanel" class="btn btn-xs btn-default"> <i class="ion-edit"></i> Sửa</a>
                </div>
            </td>',
);
$data[] = $value;
...
$value = array(
    ...
    4 => '<td class="text-center">
                <div class="btn-group">
                    <a href="#" data-url="panel/membership_plan_edit.php?id=trial" data-toggle="slidePanel" class="btn btn-xs btn-default"> <i class="ion-edit"></i> Sửa</a>
                </div>
            </td>',
);
$data[] = $value;
...
foreach ($queryRecords as $row) {
    ...
    $row4 = '<td class="text-center">
                <div class="btn-group">
                    <a href="#" data-url="panel/membership_plan_edit.php?id='.$id.'" data-toggle="slidePanel" class="btn btn-xs btn-default"> <i class="ion-edit"></i> Sửa</a>
                    <a href="javascript:void(0)" class="btn btn-xs btn-danger item-js-delete" data-ajax-action="deleteMembershipPlan"> <i class="ion-close"></i> Xóa</a>
                </div>
            </td>';
