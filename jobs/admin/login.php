                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-md-offset-3">
                            ...
                            <div class="card" id="admin_login_card">
                                <h3 class="card-header h4">Đăng Nhập Quản Trị</h3>
                                <div class="card-block">
                                    ...
                                    <form action="#" method="post">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="password" name="password" class="form-control" id="login_password" placeholder="Mật khẩu" />
                                        </div>
                                        <?php
                                        if($config['recaptcha_mode']== 1){
                                            ?>
                                        ...
                                        <div class="form-group">
                                            <label for="frontend_login_remember" class="css-input switch switch-sm switch-app">
                                                <input type="checkbox" id="frontend_login_remember" /><span></span> Lưu thông tin đăng nhập</a>
                                            </label>
                                        </div>
                                        <button type="submit" class="btn btn-app btn-block" name="login">Đăng nhập</button>
                                    </form>
                                </div>
                                <!-- .card-block -->
                            </div>
