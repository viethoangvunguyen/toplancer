                    ...
                    <form name="form2"  class="form form-horizontal" method="post" data-ajax-action="companyEdit" id="sidePanel_form">
                        <div class="form-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <select name="country" class="form-control js-select2" id="country" data-ajax-action="getStateByCountryID"  data-placeholder="Chọn..">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <select name="state" id="state" class="form-control js-select2" data-ajax-action="getCityByStateID" data-placeholder="Chọn..">
