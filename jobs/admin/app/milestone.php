    ...
    <div class="container-fluid p-y-md">
        ...
        <div class="card">
            <div class="card-header">
                <h4>Cột mốc dự án <br>
                    <small>Dự án: <a href="<?php echo $link['PROJECT'].'/'.$_GET['id'] ?>"
                            target="_blank"><?php echo $info['product_name']; ?></a></small>
                </h4>

                <div class="pull-right hidden">
                    <a href="<?php _esc(ADMINURL);?>global/setting.php#project_setting"
                        class="btn btn-success waves-effect waves-light m-r-10">Project setting</a>
                </div>
            </div>
                ...
                <div id="js-table-list">
                    <table class="table table-bordered table-striped table-vcenter">
                        ...
                        <tbody>
                            <?php if($count == 0){ ?>
                            <tr>
                                <td colspan="4" class="text-center">Chưa có cột mốc nào được tạo cho dự án này.</td>
                            </tr>
                            <?php } ?>
